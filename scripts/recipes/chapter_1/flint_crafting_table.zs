...
[<item:appliedenergistics2:wooden_gear>, <item:stone_age:thatch_block>, <item:appliedenergistics2:wooden_gear>]], <item:stone_age:stone_hammer>.withTag({Damage: 0 as int}));
...
[<item:minecraft:air> * 0, <tag:forge:rods/wooden>, <item:minecraft:air> * 0]], <item:stone_age:stone_hammer>.withTag({Damage: 0 as int}));
...
[<item:minecraft:air> * 0, <item:ceramics:unfired_clay_plate>, <item:minecraft:air> * 0]], <item:stone_age:flint_knife>.withTag({Damage: 0 as int}));
